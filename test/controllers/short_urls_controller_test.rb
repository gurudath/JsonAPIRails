...
class ShortUrlsControllerTest < ActionController::TestCase
  ...
  test "should create short_url" do
    assert_difference('ShortUrl.count') do
      post :create, short_url: { orginal_url: @short_url.orginal_url, shorty: @short_url.shorty, user_id: @short_url.user_id, visit_count: @short_url.visit_count }
    end
  ...
  test "should update short_url" do
    patch :update, id: @short_url, short_url: { orginal_url: @short_url.orginal_url, shorty: @short_url.shorty, user_id: @short_url.user_id, visit_count: @short_url.visit_count }
    assert_redirected_to short_url_path(assigns(:short_url))
  end
